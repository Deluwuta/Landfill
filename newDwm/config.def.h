...
/* key definitions */
#define MODKEY Mod4Mask // Mod1Mask: Alt | Mod4Mask: WinKey
...
static const Key keys[] = {
    ...
    {MODKEY, XK_d, spawn, SHCMD("rofi -modi combi -show combi -display-combi 'Rufos ~>>' -combi-modi run,drun")},
    ...
    // Hides bar
    {Mod1Mask | ShiftMask, XK_h, togglebar, {0}},

    {MODKEY, XK_space, zoom, {0}}, // Focused window = Master

    /* { MODKEY, XK_Tab, view, {0}}, // Rotate between the last two used
       workspaces */
    ...
    {MODKEY | ControlMask, XK_v, togglefloating, {0}},

    /* { MODKEY, XK_0, view, {.ui = ~0}}, */
    /* { MODKEY | ShiftMask, XK_0, tag, {.ui = ~0}}, // Fija la focused window
     */
