...
-- https://github.com/streetturtle/ui.wibar.widgets/tree/master/volume-widget
...
local utils = require("ui.wibar.widgets.volume-widget.utils")
...
local widget_types = {
    icon_and_text = require("ui.wibar.widgets.volume-widget.widgets.icon-and-text-widget"),
    icon = require("ui.wibar.widgets.volume-widget.widgets.icon-widget"),
    arc = require("ui.wibar.widgets.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("ui.wibar.widgets.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("ui.wibar.widgets.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
